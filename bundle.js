...
/***/ function(module, exports, __webpack_require__) {
	...
	var user2 = __webpack_require__(7);
	...
	var signOutP1 = function signOutP1(success, failure) {
	  $.ajax({
	    method: 'DELETE',
	...
	var signOutP2 = function signOutP2(success, failure) {
	  $.ajax({
	    method: 'DELETE',
	...
	var changePw2 = function changePw2(success, failure, data) {
	  $.ajax({
	    method: 'PATCH',
	...
	var changePw1 = function changePw1(success, failure, data) {
	  $.ajax({
	    method: 'PATCH',
	...
	var getStuff = function getStuff(success, failure, data) {
	  $.ajax({
	    method: 'GET',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signInSuccessP1 = function signInSuccessP1(data) {
	  user1.user = data.user;
	  console.log(user1);
	};

	var signInSuccessP2 = function signInSuccessP2(data) {
	...
	var signOutSuccessP1 = function signOutSuccessP1() {
	  console.log(user1.user);
	  user1.user = null;
	  console.log('Signed Out!');
	};

	var signOutSuccessP2 = function signOutSuccessP2() {
	  user2.user = null;
	  console.log('Signed Out!');
	};

	var changePw2Success = function changePw2Success(data) {
	  console.log(user2.user);
	};

	var changePw1Success = function changePw1Success(data) {
	  console.log(user1.user);
	};

	var changePw1Failure = function changePw1Failure(data) {
	  console.log(data);
	};

	var changePw2Failure = function changePw2Failure(data) {
	  console.log(data);
	};
	...
	var getStuffFailure = function getStuffFailure(data) {
	  console.log(data);
	};
	...
	module.exports = {
	  failure: failure,
	  success: success,
	  signInSuccessP1: signInSuccessP1,
	  signOutSuccessP1: signOutSuccessP1,
	  signInSuccessP2: signInSuccessP2,
	  signOutSuccessP2: signOutSuccessP2,
	  changePw2Failure: changePw2Failure,
	  changePw1Failure: changePw1Failure,
	  changePw1Success: changePw1Success,
	  changePw2Success: changePw2Success,
	  getStuffFailure: getStuffFailure,
	  getStuffSuccess: getStuffSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createGame = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameCreationSuccess = function gameCreationSuccess(data) {
	  game.game = data;
	  console.log('YOU DID IT!!!!', game.game.game);
	};

	var gameCreationFailure = function gameCreationFailure(data) {
	  console.log('fail', data);
	};

	var gameUpdateSuccess = function gameUpdateSuccess(data) {
	  console.log('Update Worked', data);
	};

	var gameUpdateFailure = function gameUpdateFailure(data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var findWin = __webpack_require__(14);
	var game = __webpack_require__(12);
	var move = __webpack_require__(15);
	var updateApi = __webpack_require__(16);
	var ui = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var findWinOrTie = function findWinOrTie() {
	  var win = false;
	  var tie = false;
	  var winner = void 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var makeMoveX = function makeMoveX(currentBox) {
	...
	var makeMoveO = function makeMoveO(currentBox) {
